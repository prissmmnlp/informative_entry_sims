...
results <- results %>% mutate(true_is_sig = ifelse(true_biomarker_p_observedsize < 0.05, 'Yes', 'No')) %>% mutate(observed_is_sig = ifelse(observed_biomarker_p < 0.05, 'Yes', 'No')) %>% mutate(true_biomarker_hr=exp(true_biomarker_coef)) %>% mutate(observed_biomarker_hr=exp(observed_biomarker_coef)) %>% mutate(`Inference result` = case_when(
...
plot1 <- ggplot(results, aes(x=num_patients_observed, y=true_biomarker_hr, color=`Inference result`)) + geom_point() + scale_color_brewer(palette='Dark2')  + ylim(0,5) + xlab("Patients observed (N)") +ylab("True biomarker HR")

plot2 <- ggplot(results, aes(x=observed_biomarker_hr, y=true_biomarker_hr, color=`Inference result`)) + geom_point() + scale_color_brewer(palette='Dark2') + ylim(0,5) + xlim(0,5) + xlab("Observed biomarker HR") + ylab("True biomarker HR")
...
plot4 <- gghistogram(results, x='cox_coefs', xlab='Cox coefficient for time',color='blue', fill='lightblue', xlim=c(-0.15,0.15))
...
print(table(results$`Inference result`))
print(table(results$`Inference result`)/nrow(results))
...
ggsave2('figure1.pdf', plot=panel_plot,width=10.5, height=8.5)
...
plot4 <- gghistogram(results, x='cox_coefs', xlab='Cox coefficient for time', color='blue', fill='lightblue', xlim=c(-2, 0.3), bins=20000)
...
ggsave2('figure2.pdf', plot=panel_plot,width=10.5, height=8.5)
...
results <- results %>% mutate(true_is_sig = ifelse(true_biomarker_p_observedsize < 0.05, 'Yes', 'No')) %>% mutate(observed_is_sig = ifelse(observed_biomarker_p < 0.05, 'Yes', 'No')) %>% mutate(`Inference result` = case_when(
  is.na(observed_biomarker_coef) ~ 'Biomarker inference failed',
  true_biomarker_coef <= 0 & observed_biomarker_coef > 0 & observed_is_sig == 'Yes' ~ 'No association exists, falsely detected',
  true_biomarker_coef <= 0 & observed_biomarker_coef <= 0 & observed_is_sig == 'Yes' ~ 'No association exists, wrong association detected',
  true_biomarker_coef <= 0 & observed_is_sig == 'No' ~ 'No association exists, none detected',
...
plot1 <- ggplot(results, aes(x=num_patients_observed, y=true_biomarker_coef, color=`Inference result`)) + geom_point() + scale_color_brewer(palette='Dark2') + ylim(-2,2.5) + xlab("Patients observed (N)") +ylab("True biomarker HR")

plot2 <- ggplot(results, aes(x=observed_biomarker_coef, y=true_biomarker_coef, color=`Inference result`)) + geom_point() + scale_color_brewer(palette='Dark2') + xlim(-2,2.5) + ylim(-2.5,2.5) + xlab("Observed biomarker HR") + ylab("True biomarker HR")
...
plot3 <- ggplot(results, aes(x=proportion_early, y=kendalls, color=`Inference result`)) + geom_point() + scale_color_brewer(palette='Dark2') + xlim(0,0.1) + xlab('Proportion genotyped early/independently') + ylab("Conditional Kendall's tau")


plot4 <- gghistogram(results, x='kendalls', xlab="Conditional Kendall's tau", color='blue', fill='lightblue')


plot5 <- gghistogram(results, x='cox_coefs', xlab='Cox coefficient for time', color='blue', fill='lightblue', xlim=c(-0.25, 0.25), bins=100)
...
ggsave2('figure3.pdf', plot=panel_plot,width=10.5, height=9)
...
plot1 <- ggplot(results, aes(x=num_patients_observed, y=true_biomarker_coef, color=`Inference result`)) + geom_point() + scale_color_brewer(palette='Dark2') + ylim(-2,5) + xlab("Patients observed (N)") +ylab("True biomarker HR")

plot2 <- ggplot(results, aes(x=observed_biomarker_coef, y=true_biomarker_coef, color=`Inference result`)) + geom_point() + scale_color_brewer(palette='Dark2') + xlim(-5,5) + ylim(-5,5) + xlab("Observed biomarker HR") + ylab("True biomarker HR")
...
plot4 <- gghistogram(results, x='cox_coefs', xlab='Cox coefficient for time', color='blue', fill='lightblue', xlim=c(-0.1, 0.1), bins=100000)
...
ggsave2('figure4.pdf', plot=panel_plot,width=10.5, height=9)
